        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ComponentsTypeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Components_ComponentTypes_ComponentsTypeId",
                        column: x => x.ComponentsTypeId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Gaming Beast X", 5, 36, 12.5m },
                    { 2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Office Mini Pro", 12, 24, 4.2m },
                    { 3, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Gaming Beast XII", 1, 12, 15m }
                });

            migrationBuilder.InsertData(
                table: "Components",
                columns: new[] { "Code", "ComponentsManufacturersId", "ComponentsTypeId", "Description", "Name" },
                values: new object[,]
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Components_ComponentsTypeId",
                table: "Components",
                column: "ComponentsTypeId");
